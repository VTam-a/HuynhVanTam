...
public class GamePanel extends JPanel {
    ...
    // Kích thước cố định cho tất cả level
    ...
    private void loadLevel(int level) {
        ...
        // Tính cellSize để maze vừa khít với PANEL_SIZE
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Tính offset để center maze trong panel
